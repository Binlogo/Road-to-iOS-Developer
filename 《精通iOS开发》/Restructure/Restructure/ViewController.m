...
- (void)viewDidLoad {
    ...
    UIInterfaceOrientation currenOrientation = app.statusBarOrientation;
    [self doLayoutForOrientation:currenOrientation];
}
...
- (void)layoutLandscape {
    ...
    CGFloat buttonX = CGRectGetWidth(b) - buttonWidth -(3*spacing);
